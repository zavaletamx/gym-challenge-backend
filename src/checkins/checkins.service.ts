...
export class CheckinsService {
  ...
  async create(userId: number, file: Express.Multer.File, createCheckinDto: CreateCheckinDto) {
    if (!file) {
  ...
  async remove(id: number, userId: number, isAdmin: boolean) {
    ...
    if (!isAdmin && checkin.userId !== userId) {
      throw new BadRequestException('You can only delete your own checkins');
    }
